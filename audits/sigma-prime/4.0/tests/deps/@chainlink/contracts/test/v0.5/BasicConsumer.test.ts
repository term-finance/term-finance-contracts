import { contract, debug, helpers as h, matchers, oracle, setup } from "@chainlink/test-helpers";
...
describe("BasicConsumer", () => {
  ...
  describe("#requestEthereumPrice", () => {
    describe("without LINK", () => {
      it("reverts", () => matchers.evmRevert(cc.requestEthereumPrice(currency, payment)));
    });
  ...
  describe("#fulfillOracleRequest", () => {
    ...
    describe("when the consumer does not recognize the request ID", () => {
      ...
      it("does not accept the data provided", async () => {
        ...
        await oc.connect(roles.oracleNode).fulfillOracleRequest(...oracle.convertFufillParams(otherRequest, response));
    ...
    describe("when called by anyone other than the oracle contract", () => {
      it("does not accept the data provided", async () => {
        await matchers.evmRevert(cc.connect(roles.oracleNode).fulfill(request.requestId, response));
  ...
  describe("#withdrawLink", () => {
    ...
    it("transfers LINK out of the contract", async () => {
      ...
      const consumerBalance = ethers.utils.bigNumberify(await link.balanceOf(roles.consumer.address));
