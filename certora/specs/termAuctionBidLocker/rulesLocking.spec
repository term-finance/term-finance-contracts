...
use rule lockBidsIntegrity;
use rule lockBidsDoesNotAffectThirdParty;
use rule lockBidsMonotonicBehavior;

use rule lockBidsWithReferralIntegrity;
use rule lockBidsWithReferralDoesNotAffectThirdParty;
use rule lockBidsWithReferralMonotonicBehavior;
