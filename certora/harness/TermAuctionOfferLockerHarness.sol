...
contract TermAuctionOfferLockerHarness is TermAuctionOfferLocker {
    function isTermContractPaired() external view returns (bool) {
        return termContractPaired;
    }

    function harnessGetInternalOffers(
        bytes32 offerId
    ) external view returns (TermAuctionOffer memory) {
        return offers[offerId];
    }

    function harnessGenerateOfferPriceHash(
        uint256 price,
        uint256 nonce
    ...
    function harnessGetInternalOfferId(
        bytes32 offerId
    ) external view returns (bytes32) {
        return offers[offerId].id;
    }

    function harnessGetInternalOfferOfferor(
        bytes32 offerId
    ) external view returns (address) {
        return offers[offerId].offeror;
    }

    function harnessGetInternalOfferAmount(
        bytes32 offerId
    ) external view returns (uint256) {
        return offers[offerId].amount;
    }

    function harnessGetInternalOfferIsRevealed(
        bytes32 offerId
    ) external view returns (bool) {
        return offers[offerId].isRevealed;
    }

    function harnessGetInternalOfferOfferRevealedPrice(
        bytes32 offerId
    ) external view returns (uint256) {
        return offers[offerId].offerPriceRevealed;
    }

    function harnessGetInternalOfferOfferPriceHash(
        bytes32 offerId
    ) external view returns (bytes32) {
    ...
    function harnessCompareIncomingOfferWithInternalOffer(
        TermAuctionOffer calldata incomingOffer,
        bytes32 offerId
    ) external view returns (bool) {
        return (incomingOffer.id == offers[offerId].id &&
            incomingOffer.offeror == offers[offerId].offeror &&
            incomingOffer.offerPriceHash == offers[offerId].offerPriceHash &&
            incomingOffer.offerPriceRevealed ==
            offers[offerId].offerPriceRevealed &&
    ...
    function harnessGenerateOfferId(
        bytes32 offerId,
        address offeror
    ) external view returns (bytes32) {
    ...
    function generateOfferIdPreview(
        bytes32 id,
        address user
    ) external view returns (bytes32) {
